...
type AuditEntity = 'property' | 'owner' | 'tenant' | 'contract' | 'contract_amendment' | 'property_owner' | 'payment' | 'feature_config' | 'property_photo' | 'system_config' | 'document' | 'property_service'
