    ...
    <div className="min-h-screen bg-[#0f172a] text-white">
      ...
      <nav className="h-28 bg-white border-b border-[#E2E8F0] flex items-center sticky top-0 z-50">
        <div className="max-w-6xl mx-auto w-full flex items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="#propiedades"
              className="bg-accent hover:bg-accent/90 text-[#0F172A] text-sm font-bold px-4 py-2.5 rounded-lg transition-colors"
            >
              Ver propiedades
            </Link>
          </div>
      ...
      <section className="relative h-[88vh] min-h-[560px] flex items-end">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pb-20 w-full">
          <span className="inline-flex items-center gap-2 bg-accent/15 border border-accent/30 text-accent text-xs font-semibold px-4 py-2 rounded-full mb-6 font-sans">
          ...
          <h1 className="font-heading text-6xl md:text-7xl text-white leading-[1.05] mb-6 max-w-3xl">
            Tu próximo hogar,{' '}
            <em className="bg-gradient-to-r from-accent to-[#c4e870] bg-clip-text text-transparent">
              aquí.
            </em>
          </h1>
          ...
          <div className="flex flex-wrap gap-3">
            <a
              href="#propiedades"
              className="inline-flex items-center gap-2 bg-accent text-[#0f172a] font-sans font-bold text-sm px-6 py-3.5 rounded-xl hover:bg-accent/90 transition-colors"
            >
      ...
      {/* Stats bar */}
      <section className="border-y border-white/8 bg-[#1e293b]">
        <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-3 gap-8 sm:divide-x divide-white/10">
          <div
          ...
          >
            ...
            <p className="text-white/50 text-sm uppercase tracking-widest mt-2 font-sans">Disponibles hoy</p>
          </div>
          <div
            className="text-center px-6"
          ...
          >
            ...
            <p className="text-white/50 text-sm uppercase tracking-widest mt-2 font-sans">Años de experiencia</p>
          </div>
          <div
            className="text-center px-6"
          ...
          >
            ...
            <p className="text-white/50 text-sm uppercase tracking-widest mt-2 font-sans">Gestión profesional</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <h2 className="font-heading text-4xl text-white leading-tight mb-5">
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-sans font-semibold text-sm text-white">Transparencia</p>
                    <p className="text-xs text-white/50 mt-0.5 leading-relaxed">Cada cláusula, cada cobro y cada novedad explicados con claridad.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="mt-0.5 w-9 h-9 rounded-lg bg-accent/10 border border-accent/20 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <p className="font-sans font-semibold text-sm text-white">Acompañamiento</p>
                    <p className="text-xs text-white/50 mt-0.5 leading-relaxed">Estamos contigo desde la búsqueda hasta la renovación del contrato.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="mt-0.5 w-9 h-9 rounded-lg bg-accent/10 border border-accent/20 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <p className="font-sans font-semibold text-sm text-white">Profesionalismo</p>
                    <p className="text-xs text-white/50 mt-0.5 leading-relaxed">Más de 5 años administrando inmuebles con rigor, puntualidad y ética.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl bg-white/5 border border-white/10 p-8">
                <p className="text-white/40 font-sans font-semibold text-xs uppercase tracking-widest mb-3">Visión</p>
                <p className="font-heading text-xl text-white leading-snug">
      ...
      <section className="bg-[#0f172a] py-24 border-t border-white/8">
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              <p className="text-white/40 font-sans font-semibold text-xs uppercase tracking-widest mb-3">
                Aliados Comerciales
              </p>
              <h2 className="font-heading text-4xl text-white leading-tight max-w-lg">
            ...
            <p className="text-white/55 font-sans text-sm leading-relaxed max-w-xs">
              En alianza con <span className="font-semibold text-white">Suramericana</span>, te respaldamos y garantizamos que siempre recibas tus ingresos, incluso si el inquilino incumple.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div
                key={title}
                className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-7 flex items-start gap-5 hover:border-accent/30 hover:bg-white/8 transition-all duration-300"
              >
                <span className="w-11 h-11 rounded-xl bg-accent/15 border border-accent/20 flex items-center justify-center shrink-0">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-accent">
                    {icon}
                  </svg>
                </span>
                <div>
                  <p className="font-sans font-semibold text-base text-white mb-1">{title}</p>
          ...
          <p className="mt-8 text-center text-xs text-white/30 font-sans">
            Seguro de arrendamiento ofrecido por <span className="font-semibold text-white/50">Suramericana S.A.</span> — Vigilada Superfinanciera de Colombia
          </p>
        </div>
      </section>

      {/* Properties */}
      <section id="propiedades" className="py-20 border-t border-white/8">
        <div className="max-w-6xl mx-auto px-6">
          {available.length === 0 ? (
            <div className="text-center py-24">
              ...
              <h3 className="font-sans font-semibold text-xl text-white mb-2">Sin propiedades disponibles</h3>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-accent text-[#0f172a] text-sm font-semibold px-5 py-2.5 rounded-xl hover:bg-accent/90 transition-colors"
              >
            ...
            <>
              <div className="flex items-end justify-between mb-10">
                ...
                <p className="text-white/40 text-sm hidden md:block font-sans">
                ...
                {available.map((property) => {
                  ...
                  return (
                    <Link
                      ...
                      className="group relative block bg-[#1e293b] border border-white/8 rounded-2xl overflow-hidden hover:border-white/20 hover:shadow-2xl hover:shadow-black/60 hover:-translate-y-1 transition-all duration-300"
                    >
                      ...
                      <div className="relative h-[240px] overflow-hidden">
                        ...
                        <span className="absolute top-3 left-3 bg-white/15 backdrop-blur-sm border border-white/20 text-white text-[0.65rem] font-semibold px-2.5 py-1 rounded-lg uppercase font-sans">
                          {TYPE_LABELS[property.type] ?? property.type}
                        </span>
                        <span className="absolute top-3 right-3 bg-accent text-[#0f172a] text-[0.65rem] font-bold px-2.5 py-1 rounded-full uppercase tracking-wide font-sans">
                          Disponible
                        </span>

                        {property.monthly_price && (
                          <div className="absolute bottom-3 left-4">
                            <p className="text-white/60 text-[0.6rem] uppercase tracking-wider font-sans">Arriendo mensual</p>
                            <p className="text-white font-bold text-xl leading-none font-sans">
                              ${property.monthly_price.toLocaleString('es-CO')}
                              <span className="text-xs font-normal text-white/60 ml-1">/mes</span>
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      {/* Body */}
                      <div className="p-5">
                        <h3 className="font-heading text-lg text-white leading-snug">{property.name}</h3>
                        <p className="text-white/45 text-sm mt-1 font-sans flex items-center gap-1.5">
      ...
      {/* Footer */}
      <footer className="bg-[#0c1224] border-t border-white/8 pt-16 pb-8 mt-8">
        <div className="max-w-6xl mx-auto px-6">
