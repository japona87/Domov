  ...
  public: {
    Tables: {
      ...
      owners: {
        ...
        Insert: { id?: string; full_name: string; document_number?: string | null; phone?: string | null; email?: string | null }
        Update: { full_name?: string; document_number?: string | null; phone?: string | null; email?: string | null }
        Relationships: []
      }
      properties: {
        ...
        Insert: { id?: string; name: string; address: string; type: string; description?: string | null; features?: PropertyFeatures; is_published?: boolean }
        Update: { name?: string; address?: string; type?: string; description?: string | null; features?: PropertyFeatures; is_published?: boolean }
        Relationships: []
      }
      property_owners: {
